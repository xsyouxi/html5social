<html>
  <head>
    ...
    <g:javascript src="PublicChat/desktop/controllers/TopicInputController.js" />
    <g:javascript src="../jsTest/PublicChat/desktop/controllers/TopicInputControllerTest.js" />
