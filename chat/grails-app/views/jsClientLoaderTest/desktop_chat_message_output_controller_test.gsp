<html>
  <head>
    ...
    <g:javascript src="PublicChat/desktop/controllers/ChatMessageOutputController.js" />
    <g:javascript src="../jsTest/PublicChat/desktop/controllers/ChatMessageOutputControllerTest.js" />
